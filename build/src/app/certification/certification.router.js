...
let CertificationController = class CertificationController extends tsoa_1.Controller {
    getAllCertifications() {
        return __awaiter(this, void 0, void 0, function* () {
            let certificationService = new certification_service_1.default();
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CertificationController.prototype, "createCertification", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CertificationController.prototype, "deleteCertification", null);
CertificationController = __decorate([
    (0, tsoa_1.Tags)('Certification'),
    (0, tsoa_1.Route)('/api/certification')
